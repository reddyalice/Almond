...
public class Dictionary <K, V> implements Iterable<Dictionary.Entry<K, V>>  {
	...
	public Dictionary (int initialCapacity, float loadFactor) {
		...
		int tableSize = DSet.tableSize(initialCapacity, loadFactor);
	...
	public Dictionary (Dictionary<? extends K, ? extends V> map) {
	...
	public void putAll (Dictionary<? extends K, ? extends V> map) {
	...
	public void shrink (int maximumCapacity) {
		...
		int tableSize = DSet.tableSize(maximumCapacity, loadFactor);
	...
	public void ensureCapacity (int additionalCapacity) {
		int tableSize = DSet.tableSize(size + additionalCapacity, loadFactor);
		if (keyTable.length < tableSize) resize(tableSize);
	}
	...
	static private abstract class MapIterator<K, V, I> implements Iterable<I>, Iterator<I> {
		...
		final Dictionary<K, V> map;
		int nextIndex, currentIndex;
		boolean valid = true;

		public MapIterator (Dictionary<K, V> map) {
			this.map = map;
			reset();
		}
	...
	static public class Entries<K, V> extends MapIterator<K, V, Entry<K, V>> {
		...
		public Entries (Dictionary<K, V> map) {
			super(map);
		}
	...
	static public class Values<V> extends MapIterator<Object, V, V> {
		public Values (Dictionary<?, V> map) {
			super((Dictionary<Object, V>)map);
		}
	...
	static public class Keys<K> extends MapIterator<K, Object, K> {
		public Keys (Dictionary<K, ?> map) {
			super((Dictionary<K, Object>)map);
		}
