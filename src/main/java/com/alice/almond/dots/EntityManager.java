...
public class EntityManager {
    ...
    private ComponentOperationHandler componentOperationHandler = new ComponentOperationHandler(new ManagerDelayedInformer());
    ...
    public void update(float deltaTime){
		...
		try {
			for (int i = 0; i < systems.size(); ++i) {
				...
				while(componentOperationHandler.hasOperationsToProcess() || entityHandler.hasPendingOperations()) {
