...
public class ComponentFamily {
	private static Dictionary<String, ComponentFamily> families = new Dictionary<String, ComponentFamily>();
	...
	private ComponentFamily (Bits all, Bits any, Bits exclude) {
		this.all = all;
		this.one = any;
	...
	public static class Builder {
		...
		public ComponentFamily get () {
			String hash = getFamilyHash(all, one, exclude);
			ComponentFamily family = families.get(hash, null);
			if (family == null) {
				family = new ComponentFamily(all, one, exclude);
